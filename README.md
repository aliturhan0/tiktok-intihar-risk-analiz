...
🧠 Projenin Amacı
Bu proje, TikTok videolarından elde edilen metinsel içerikleri (caption/transcript) analiz ederek psikolojik risk içeren davranışları erken tespit etmeyi amaçlar.
Ana hedefler:
...
Transcript şu adımlardan geçer:
...
✔ 2) Self-Attention
Her kelime cümlenin diğer kelimeleriyle bağlam ilişkisi kurar.
